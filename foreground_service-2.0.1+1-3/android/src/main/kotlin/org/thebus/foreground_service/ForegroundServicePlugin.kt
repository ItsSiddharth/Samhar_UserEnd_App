...
class ForegroundServicePlugin: FlutterPlugin, MethodCallHandler, IntentService("org.thebus.ForegroundServicePlugin") {
  ...
  companion object {
    ...
    private const val INTENT_ACTION_STOP_SERVICE = "Stop Service"
  ...
  class NotificationHelper(val notificationId: Int = 1){
    ...
    private val builder: NotificationCompat.Builder by lazy{
      ...
      val stopSelf = Intent(myAppContext(), ForegroundServicePlugin::class.java)
      stopSelf.setAction(INTENT_ACTION_STOP_SERVICE)
      val stopSelfIntent: PendingIntent = PendingIntent.getService(myAppContext(), 0, stopSelf, PendingIntent.FLAG_CANCEL_CURRENT)
      ...
      try {
        ...
        newBuilder
                ...
                .addAction(getHardcodedIconResourceId(), "Stop", stopSelfIntent)
